...
public class Main {
    ...
    private static void AddCatInLinkedListMiddle(List<Cat> linkedList) {
        long start = System.currentTimeMillis();
        for (int i = 0; i < 100; i++) {
            linkedList.add(linkedList.size() / 2, new Cat(random.nextInt(1 + 4)-1));
        }
    ...
    private static void AddCatInLinkedListBeginningEnd(LinkedList<Cat> linkedList) {
        long start = System.currentTimeMillis();
        for (int i = 0; i < 100; i++) {
            linkedList.addFirst(new Cat(random.nextInt(1 + 4)-1));
        }
        for (int i = 0; i < 100; i++) {
            linkedList.addLast(new Cat(random.nextInt(1 + 4)-1));
        }
    ...
    private static void AddCatInArrayListInMiddle(List<Cat> arrayList) {
        long start = System.currentTimeMillis();
        for (int i = 0; i < 100; i++) {
            arrayList.add(arrayList.size() / 2, new Cat(random.nextInt(1 + 4)-1));
        }
    ...
    private static void AddCatInArrayListBeginningEnd(ArrayList<Cat> arrayList) {
        long start = System.currentTimeMillis();
        for (int i = 0; i < 100; i++) {
            arrayList.add(0,new Cat(random.nextInt(1 + 4)-1));
        }
        for (int i = 0; i < 100; i++) {
            arrayList.add(arrayList.size(), new Cat(random.nextInt(1 + 4)-1));
        }
    ...
    private static void AddCatInArrayList(List<Cat> arrayList) {
        ...
        for (int i = 0; i < 1000000; i++) {
            arrayList.add(new Cat(random.nextInt(1 + 4)-1));
        }
    ...
    private static void AddCatInLinkedList(List<Cat> linkedList) {
        long start = System.currentTimeMillis();
        for (int i = 0; i < 1000000; i++) {
            linkedList.add(new Cat(random.nextInt(1 + 4)-1));
        }
